            ...
            <div class="card-box table-responsive">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="btn-group pull-right m-t-15">
                            <a href="<?php echo e(route('admin.roles.add')); ?>" class="btn btn-success waves-effect waves-light">Добавить <i class="glyphicon glyphicon-plus"></i></a>
                        </div>

                        <h4 class="m-t-0 header-title"><b><?php echo e(trans('core::roles.top_name')); ?></b></h4>
                        <p class="text-muted font-13 m-b-30">
                            <?php echo e(trans('core::roles.description_all')); ?>
                ...
                <div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <select name="sort_name" class="form-control" style="width:100px;" onchange="this.form.submit()">
                                        <?php if(isset($sort_name)): ?>
                                            ...
                                            <option value="ru_name" <?php echo e(($sort_name == 'ru_name') ? 'selected' : ''); ?>>Название роли</option>
                                        <?php endif; ?>
                                    </select>
                                        ...
                                        <?php if($roles->count() > 0): ?>
                                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr role="row" class="<?php echo e(($loop->count % 2) ? 'odd' : 'even'); ?>">
                                                    ...
                                                    <td>
                                                        <?php if(!$role->access->isEmpty()): ?>
                                                            <?php $__currentLoopData = $role->access; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $access): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php echo e($access->ru_name); ?> <br />
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <?php else: ?>
                                                    ...
                                                    <td class="actions">
                                                        <a href="<?php echo e(route('admin.roles.edit', $role->id )); ?>" class="on-default edit-row"><i class="fa fa-pencil fa-lg" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Изменить"></i></a>
                                                        <a href="<?php echo e(route('admin.roles.delete', $role->id)); ?>" class="on-default remove-row"><i class="fa fa-trash-o fa-lg" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Удалить"></i></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
                                            <tr role="row" class="even">
                                                <td colspan="5"><b><?php echo e(trans('core::roles.items_none')); ?></b></td>
                                            </tr>
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <tr role="row" class="even">
                                            <td colspan="5"><b><?php echo e(trans('core::roles.items_not_isset')); ?></b></td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <?php if(isset($roles)): ?>
                                <div class="dataTables_info" id="datatable_info" role="status" aria-live="polite">Показано <?php echo e($roles->count()); ?> из <?php echo e($roles->total()); ?> записей</div>
                            <?php endif; ?>
                        </div>
                        <div class="col-sm-6">
                            <div class="dataTables_paginate paging_simple_numbers" id="datatable_paginate">
                                <?php if(isset($roles)): ?>
                                    <?php echo e($roles->appends(['count_on_page' => $count_on_page, 'sort_name' => $sort_name, 'sort_arrow' => $sort_arrow, 'search_text' => $search_text, 'date_type'=>$date_type, 'date_s'=> $date_s, 'date_po'=>$date_po])->links()); ?>
