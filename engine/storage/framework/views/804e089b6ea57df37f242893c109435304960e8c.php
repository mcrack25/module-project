                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p class="text-muted font-13 m-b-30">
                            <?php echo e(trans('core::routes.description_edit')); ?>

                        </p>
                    </div>
                </div>

                <form role="form" method="POST" action="<?php echo e(route('admin.routes.post_edit', $route->id)); ?>">
                            ...
                            <table id="datatable" class="table table-bordered dataTable no-footer text-center table_middle" role="grid" >
                                <tbody>
                                    <tr role="row">
                                        ...
                                        <td><input name="ru_name" type="text" class="form-control" placeholder="Название роута" value="<?php echo e($route->ru_name); ?>" required></td>
                                    </tr>
                                    <tr role="row">
                                        <th class="text-right">Роут:</th>
                                        <td><input name="route" type="text" class="form-control" placeholder="Роут" value="<?php echo e($route->route); ?>" required></td>
                                    </tr>
                                    <tr role="row">
                                            ...
                                            <select class="form-control" name="access_id">
                                                <?php if($accesses): ?>
                                                    <?php $__currentLoopData = $accesses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $access): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($route->access_id == $access->id): ?>
