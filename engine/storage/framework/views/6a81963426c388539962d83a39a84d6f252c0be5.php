            ...
            <div class="card-box table-responsive">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="btn-group pull-right m-t-15">
                            <a href="<?php echo e(route('admin.users.add')); ?>" class="btn btn-success waves-effect waves-light">Добавить <i class="glyphicon glyphicon-plus"></i></a>
                        </div>

                        <h4 class="m-t-0 header-title"><b><?php echo e(trans('core::users.top_name')); ?></b></h4>
                        <p class="text-muted font-13 m-b-30">
                            <?php echo e(trans('core::users.description_all')); ?>
                ...
                <div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <select name="sort_name" class="form-control" style="width:100px;" onchange="this.form.submit()">
                                        <?php if(isset($sort_name)): ?>
                                            ...
                                            <option value="email" <?php echo e(($sort_name == 'email') ? 'selected' : ''); ?>>Логин</option>
                                            <option value="name" <?php echo e(($sort_name == 'name') ? 'selected' : ''); ?>>ФИО или ОГВ</option>
                                        <?php endif; ?>
                                    </select>
                                        ...
                                        <?php if($users->count() > 0): ?>
                                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr role="row" class="<?php echo e(($loop->count % 2) ? 'odd' : 'even'); ?>">
                                                    ...
                                                    <td><?php echo isset($user->role->ru_name) ? $user->role->ru_name : '<b style="color:red;">Нет роли</b>'; ?></td>
                                                    <td class="actions">
                                                        <a href="<?php echo e(route('admin.users.edit', $user->id )); ?>" class="on-default edit-row"><i class="fa fa-pencil fa-lg" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Изменить"></i></a>
                                                        <a href="<?php echo e(route('admin.users.delete', $user->id)); ?>" class="on-default remove-row"><i class="fa fa-trash-o fa-lg" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Удалить"></i></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
                                            <tr role="row" class="even">
                                                <td colspan="5"><b><?php echo e(trans('core::users.items_none')); ?></b></td>
                                            </tr>
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <tr role="row" class="even">
                                            <td colspan="5"><b><?php echo e(trans('core::users.items_not_isset')); ?></b></td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <?php if(isset($users)): ?>
                                <div class="dataTables_info" id="datatable_info" role="status" aria-live="polite">Показано <?php echo e($users->count()); ?> из <?php echo e($users->total()); ?> записей</div>
                            <?php endif; ?>
                        </div>
                        <div class="col-sm-6">
                            <div class="dataTables_paginate paging_simple_numbers" id="datatable_paginate">
                                <?php if(isset($users)): ?>
                                    <?php echo e($users->appends(['count_on_page' => $count_on_page, 'sort_name' => $sort_name, 'sort_arrow' => $sort_arrow, 'search_text' => $search_text, 'date_type'=>$date_type, 'date_s'=> $date_s, 'date_po'=>$date_po])->links()); ?>
