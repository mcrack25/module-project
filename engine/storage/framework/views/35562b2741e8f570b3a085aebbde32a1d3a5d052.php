                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p class="text-muted font-13 m-b-30">
                            <?php echo e(trans('core::roles.description_edit')); ?>

                        </p>
                    </div>
                </div>

                <form role="form" method="POST" action="<?php echo e(route('admin.roles.post_edit', $role->id)); ?>">
                            ...
                            <table id="datatable" class="table table-bordered dataTable no-footer text-center table_middle" role="grid" >
                                <tbody>
                                    <tr role="row">
                                        ...
                                        <td><input name="ru_name" type="text" class="form-control" placeholder="Название роли" value="<?php echo e($role->ru_name); ?>" required></td>
                                    </tr>
                                    <tr role="row">
                                                    ...
                                                    <?php $__currentLoopData = $access; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $access_one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li>
                                                            <div class="form-group">
                                                                <input name="access[<?php echo e($access_one->id); ?>]"
                                                                    <?php $__currentLoopData = $role_access; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role_access_one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php if($role_access_one->id == $access_one->id): ?>
                                                                            checked
                                                                        <?php endif; ?>
