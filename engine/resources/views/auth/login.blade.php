...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="{{ asset('public/auth/img/favicon.png') }}" type="image/png">
        <link rel="stylesheet" href="{{ asset('public/auth/css/style.css') }}" media="screen" type="text/css" />
    </head>
