                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p class="text-muted font-13 m-b-30">
                            {{ trans('core::routes.description_add') }}
                        </p>
                    </div>
                </div>

                <form role="form" method="POST" action="{{ route('admin.routes.post_add') }}">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="datatable" class="table table-bordered dataTable no-footer text-center table_middle" role="grid" >
                                <tbody>
                                    <tr role="row">
                                        ...
                                        <td><input name="ru_name" type="text" class="form-control" placeholder="Название роута" value="{{ old('ru_name') }}" required></td>
                                    </tr>
                                    <tr role="row">
                                        <th class="text-right">Роут:</th>
                                        <td><input name="route" type="text" class="form-control" placeholder="Роут" value="{{ old('route') }}" required></td>
                                    </tr>
                                    <tr role="row">
