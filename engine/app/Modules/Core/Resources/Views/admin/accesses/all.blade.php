                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="btn-group pull-right m-t-15">
                            <a href="{{ route('admin.access.add') }}" class="btn btn-success waves-effect waves-light">Добавить <i class="glyphicon glyphicon-plus"></i></a>
                        </div>

                        <h4 class="m-t-0 header-title"><b>{{ trans('core::accesses.top_name') }}</b></h4>
                        <p class="text-muted font-13 m-b-30">
                            {{ trans('core::accesses.description_all') }}
                        </p>
                    </div>
                </div>
                                    ...
                                    @if(isset($accesses))
                                        ...
                                        @else
                                            <tr role="row" class="even">
                                                <td colspan="5"><b>{{ trans('core::accesses.items_none') }}</b></td>
                                            </tr>
                                        @endif
                                    @else
                                        <tr role="row" class="even">
                                            <td colspan="5"><b>{{ trans('core::accesses.items_not_isset') }}</b></td>
                                        </tr>
                                    @endif
                                </tbody>
                            </table>
