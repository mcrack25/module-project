        ...
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                ...
                <div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                ...
                                <div id="datatable_filter" class="dataTables_filter">
                                    <label>
                                        <div class="input-group m-t-10">
                                            ...
                                            <span class="input-group-btn">
                                                <button type="submit" class="btn waves-effect waves-light btn-primary btn-sm"><i class="glyphicon glyphicon-search"></i> Искать где есть</button>
                                            </span>
                                        </div>
                                    </label>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="datatable" class="table table-striped table-bordered dataTable no-footer text-center" role="grid" aria-describedby="datatable_info">
                                <thead>
                                    <tr role="row">
