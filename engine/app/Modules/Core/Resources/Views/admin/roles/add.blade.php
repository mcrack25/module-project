                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p class="text-muted font-13 m-b-30">
                            {{ trans('core::roles.description_add') }}
                        </p>
                    </div>
                </div>

                <form role="form" method="POST" action="{{ route('admin.roles.post_add') }}">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="datatable" class="table table-bordered dataTable no-footer text-center table_middle" role="grid" >
                                ...
                                <tr role="row">
                                    ...
                                    <td><input name="ru_name" type="text" class="form-control" placeholder="Название роли" value="{{ old('ru_name') }}" required></td>
                                </tr>
                                <tr role="row">
                                                ...
                                                @foreach($access as $access_one)
                                                    <li>
                                                        <div class="form-group">
                                                            <input name="access[{{ $access_one->id }}]" type="checkbox" data-plugin="switchery" data-color="#5d9cec"/>
