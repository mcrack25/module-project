...
@section('after_bootstrap_js')
    <script src="{{ Module::asset('admin::assets/plugins/bootstrap-inputmask/bootstrap-inputmask.min.js') }}" type="text/javascript"></script>
    <script src="{{ Module::asset('admin::assets/plugins/autoNumeric/autoNumeric.js') }}" type="text/javascript"></script>
        ...
        <div class="col-lg-12">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="admin">
                    ...
                    <form class="form_table" role="form" method="POST" action="{{ route('admin.config.post_save') }}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-sm-12">
                                <table class="table table-bordered dataTable no-footer text-center" role="grid" >
                                    ...
                                    <tr role="row">
                                        ...
                                        <td><input name="admin_name" type="text" class="form-control" placeholder="Название админки" value="{{ $configs['admin_name'] or '' }}" required></td>
                                    </tr>
                                    <tr role="row">
                                        <th class="text-right">Описание админки:</th>
                                        <td><input name="admin_description" type="text" class="form-control" placeholder="Описание админки" value="{{ $configs['admin_description'] or '' }}" required></td>
                                    </tr>
